...
infecho "Time to copy something somewhere. Take it easy."
echo "=== WARNING WARNING WARNING ==="
echo
...
then
    ...
    infecho "Removing cisco as it gives 404 error ATM"
    rm rootfs/etc/yum.repos.d/fedora-cisco-openh264.repo
